---
title: Artefactos desarrollados en Kotlin
...
<CardGrid>
  <ExpandLinkCard
    ...
    description="Es un componente del artefacto que permite gestionar y aplicar esquemas de color."
    href="/segmented-user/segmented-brand/"
  />
    <ExpandLinkCard
    title="Badges"
